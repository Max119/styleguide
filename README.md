...
**Каждое свойство с новой строки. Между свойствами не должно быть пустых строк.**
```scss
//неправильно
.class-name-1 {
...
**Не указывать единицы измерения для нулевых значений (кроме времени)**
```scss
//неправильно
.class-name-1 {
    margin: 0px;
...
**Где возможно использовать сокращеную форму значения свойств**
```scss
//неправильно
.class-name-1 {
    font-size: 15px;
